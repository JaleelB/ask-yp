...
export default function Home() {
  return (
    <>
    <main className="container max-w-[1000px] display flex flex-col mx-auto flex-1">
      <section className="w-full m-auto">
        <div className="w-full flex flex-col gap-8">
          <div className="max-w-[650px] mx-auto flex flex-col gap-4 items-center p-4">
              ...
              <p className="max-w-[600px] mt-4 text-secondary text-center">AskYelp is an open source AI chatbot that can interact with the Yelp Fusion API with natural language using Open AI functions and the Vercel AI SDK</p>
          </div>
              ...
              exploreOptions.map((option, index) => (
                ...
                >
                  <div className="flex lg:flex-col lg:items-center gap-4">
                    {option.icon}
                    <h2 className="lg:text-center text-lg text-primary font-bold">{option.title}</h2>
                  </div>
        ...
        <div className="mx-auto flex flex-col items-center justify-center">
          <form className="w-full">
            <div className="w-full relative px-4 py-[10px] max-w-[750px] mx-auto">
              ...
              />
              <Button 
                className="absolute bg-transparent top-4 right-4 hover:bg-transparent"
                size="sm"
                variant="ghost"
              >
          ...
          <div className="pb-3 pt-2 text-center text-xs px-10 md:px-[60px] md:pb-6 md:pt-3">
